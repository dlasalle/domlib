...
#define DLMSET_PREFIX sint
#define DLMSET_TYPE_T sint_t
...
#define DLTHREAD_PREFIX sint
#define DLTHREAD_TYPE_T sint_t
...
/* kv_t */
#define DLMEM_PREFIX kv
#define DLMEM_TYPE_T kv_t
#include "dlmem_funcs.h"
#undef DLMEM_TYPE_T
#undef DLMEM_PREFIX

#define DLHEAP_PREFIX kv
#define DLHEAP_TYPE_T kv_t
#define DLHEAP_KEY key
#include "dlheap_funcs.h"
#undef DLHEAP_KEY
#undef DLHEAP_TYPE_T
#undef DLHEAP_PREFIX
